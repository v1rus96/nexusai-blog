          ...
          {posts.map((post) => (
            ...
            >
              <article className="flex gap-4">
                <div className="w-20 h-20 rounded-lg overflow-hidden bg-gradient-to-br from-[#E91E90]/20 to-[#C61884]/20 flex-shrink-0 relative">
                  {post.image ? (
                    <Image 
                      src={post.image} 
                      alt={post.title}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-xs px-2 py-1 rounded-full bg-[#E91E90]/10 text-[#E91E90] font-medium">
                      {post.category}
                    </span>
                  ...
                  <h3 className="font-semibold text-sm line-clamp-2 group-hover:text-[#E91E90] transition-colors text-gray-900 dark:text-gray-200">
                    {post.title}
                  </h3>
                  
                  <div className="flex items-center mt-3 text-xs text-gray-500">
                    <div className="flex items-center gap-1">
                      <div className="w-4 h-1 bg-gradient-to-r from-[#C61884] to-[#E91E90] rounded-full"></div>
                      <span>90% match</span>
                    </div>
                  </div>
                </div>

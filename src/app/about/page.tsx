  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-8 text-gray-900 dark:text-gray-100">What We Cover</h2>
      ...
      {/* Who This Is For */}
      <section className="glass-card rounded-2xl p-8 sm:p-10 mb-12">
        <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-gray-100">Who This Is For</h2>
        <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-[17px]">
      ...
      {/* Our Approach */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Our Approach</h2>
        <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-[17px] mb-4">
      ...
      <section className="mb-16">
        <h2 className="text-2xl font-bold mb-8 text-gray-900 dark:text-gray-100">The Team</h2>
        <AuthorCard />
